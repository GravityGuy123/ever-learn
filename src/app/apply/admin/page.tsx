  ...
  const submit = async () => {
    try {
      try {
        ...
        if (c?.data?.csrfToken)
          axiosInstance.defaults.headers["X-CSRFToken"] = c.data.csrfToken;
      } catch {}

      const res = await axiosInstance.post("/apply/role", { role: "admin", bio });
          ...
          <CardContent className="p-6 sm:p-8 lg:p-10 space-y-8">
            ...
            <div className="bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 rounded-xl p-4 flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-violet-800 dark:text-violet-200 leading-relaxed">
                  Administrators manage the platform, moderate content, assist users, and ensure everything runs smoothly. Share your relevant experience and skills below.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Provide details about your experience managing platforms, teams, or communities.
              </p>
            </div>
