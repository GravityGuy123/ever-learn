...
export default function ModeratorApplication() {
  ...
  // Initialize email verification status if already verified
  useEffect(() => {
  ...
  const submit = async () => {
    ...
    try {
      ...
      const res = await axiosInstance.post("/apply/role", { role: "moderator", bio });
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Join our moderation team and help create a safe, productive learning environment for everyone.
          </p>
        </div>
          ...
          <CardContent className="p-6 sm:p-8 lg:p-10 space-y-8">
            ...
            <div className="bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800 rounded-xl p-4 flex gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-violet-800 dark:text-violet-200 leading-relaxed">
                  Moderators help maintain a safe and productive learning environment by monitoring content, assisting users, and enforcing community guidelines. Share your relevant experience below.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">
                Include any experience with content moderation, community management, or conflict resolution.
              </p>
            </div>
