...
export default function CourseManagement({ params }: { params: { id: string } }) {
  ...
  // startEdit is handled inline when clicking Edit button
    ...
    <div className="max-w-4xl mx-auto p-4">
      ...
      <section className="mb-6">
        ...
        <ul className="mt-3 space-y-2">
          {((course.lessons || []) as unknown[]).map((lUnk) => {
            const l = lUnk as Lesson;
            return (
      ...
      <section className="mb-6">
        ...
        <div className="mt-3 space-y-3">
          ...
          <label className="block">
            <span className="sr-only">Upload lesson video</span>
      ...
      {editingId && (
        <section className="mb-6">
          ...
          <div className="mt-3 space-y-3">
            ...
            <label className="block">
              <span className="sr-only">Replace lesson video (optional)</span>
